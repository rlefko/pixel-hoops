...
export const TEACH_COPY: Record<CalloutTip, string> = {
  ...
  coinsEarned:
    'Coins bank the moment you earn them. Spend them between runs in the Locker and Arcade.',
  recruitRental:
  ...
  lossFraming: 'Everything below is banked: coins, favor, ladder. Only run recruits go home.',
